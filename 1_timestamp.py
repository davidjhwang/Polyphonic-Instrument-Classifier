...
# ===================== FOR EACH STEM =====================
def detect_active_timestamps(stem_path, sr=44100, threshold=0.015, gap=0.1):
...
process_all_tracks("slakh2100_flac_redux/reduced_isolated", "timestamps_isolated.txt")